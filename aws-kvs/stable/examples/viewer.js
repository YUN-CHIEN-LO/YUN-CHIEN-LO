...
async function startViewer(constraints, localView, remoteView, formValues, onStatsReport, onRemoteDataMessage) {
    ...
    const resolution = formValues.widescreen ? { width: { ideal: 80 }, height: { ideal: 40 }, deviceId: { ideal: "c5c51a6ef29d7f4e9a1d2d4cbe8ee1b9a4f2f679d0928dad16bc23e570c6300b" } } : { width: { ideal: 80 }, height: { ideal: 80 }, deviceId: { ideal: "c5c51a6ef29d7f4e9a1d2d4cbe8ee1b9a4f2f679d0928dad16bc23e570c6300b" } };
    const Constraints = {
